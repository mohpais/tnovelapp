<template>
    <nav class="navbar navbar-expand navbar-light navbar-bg">
        <a class="sidebar-toggle" type="button" @click="handleSidebar" >
            <i class="hamburger align-self-center"></i>
        </a>

        <form class="d-none d-sm-inline-block">
            <div class="input-group input-group-navbar">
                <input type="text" id="search-content" class="form-control" placeholder="Search…" aria-label="Search">
            ...
            <ul class="navbar-nav navbar-align">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" type="button" @click="handleLogout" href="#">Log out</a>
                    </div>
                </li>
            </ul>
        </div>
...
<script setup>
    ...
    const emits = defineEmits(["handleSidebar", "handleLogout"]);

    const handleSidebar = () => {
        return emits("handleSidebar");
    };
